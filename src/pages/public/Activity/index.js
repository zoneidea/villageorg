            ...
            <>
                ...
                {informationData && landmarkData && productData && foodData && activityData && accomodationData &&(
                    <>
                        ...
                        <Activity informationData={informationData} landmarkData={landmarkData} alltopvillageData={alltopvillageData} accomodationData={accomodationData} activityData={activityData} productData={productData} foodData={foodData} />
                    </>
                )}
                {/* {!informationData && (
                    <Container>
