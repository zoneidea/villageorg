            ...
            <>
                <Row>
                    <div className="housepoint">
                        <div className="clip">
                            <div style={{ objectFit: 'cover', width: "100%", height: "100%", backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundImage: `url(${hostname}/public/static/images/accomodation/${accomodationData[0].accomodationpic_1})`, backgroundPosition: 'center', backgroundPositionY: 'bottom' }}>
                            </div>
                        </div>
                ...
                <div class="list-wrapper bg-grey-2">
                    <div class="container">
                        {accomodationData.map((item, index) => (
                            <Row>
                                <Col md="12">
