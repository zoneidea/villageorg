...
class AccomodationIndex extends React.Component {
    constructor(props) {
        super(props);
            ...
            <>
                ...
                {informationData && landmarkData && productData && foodData && activityData && accomodationData &&(
                    <>
                        ...
                        <Accomodation informationData={informationData} landmarkData={landmarkData} alltopvillageData={alltopvillageData} accomodationData={accomodationData} activityData={activityData} productData={productData} foodData={foodData} />
                    </>
                )}
                {/* {!informationData && (
                    <Container>
...
export default connect(mapStateToProps, mapDispatchToProps)(AccomodationIndex);